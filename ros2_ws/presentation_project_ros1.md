...
let me quickly go through the codes, for more details i'll leave that to another demo, to discuss over algorithms, and how they affect robot behavior and how to do configuration in consideration of hardware and real life situations from engineering point of view. 
